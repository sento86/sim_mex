...
## 
## \warning  El valor de las variables SIGN_* y ROUTE_* debe ser igual a los de nav::veh::sign.
...
def build_graph( mesh ):
    ...
    # WARNING: SLOW O(n*n/2). Do it better ...
    def _cross( e0, e1, co ):
        verts.add( 1 )
        edges.add( 2 )
        verts[-1].co = co
...
if __name__ == "__main__":
    ...
    export_veh_graph( None, "/home/agv/jaime/simulator/nav_veh_graph.dat" )
    print( "DONE" )
